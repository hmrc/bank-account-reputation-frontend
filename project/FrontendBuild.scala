...
private object AppDependencies {
  ...
  val compile = Seq(
    ws excludeAll ExclusionRule(organization = "org.apache.httpcomponents"), //exclusion prevents wiremock conflict,
